...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ImageGallery",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12ImageGallery11AppDelegate")
...
SWIFT_CLASS("_TtC12ImageGallery19ImageCollectionCell")
@interface ImageCollectionCell : UICollectionViewCell
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified imgView;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC12ImageGallery7ImageVC")
@interface ImageVC : UICollectionViewController <UICollectionViewDelegateFlowLayout, UISearchBarDelegate>
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC12ImageGallery28SearchCollectionReusableView")
